...
const PeriodicalModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm p-4">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <div className="space-y-2">
                  {formData.authors.map((author, index) => (
                    <div key={index} className="flex gap-2">
                      <input
                        ...
                        value={author}
                        onChange={(e) =>
                          handleAuthorUpdate(index, e.target.value)
                        }
                  ...
                  {formData.authors.length === 0 && (
                    <p className="text-xs text-gray-500 italic">
                      No authors added. Click "Add Author" if needed.
                    </p>
                  )}
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mt-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  name="periodicalMonth"
                  value={formData.periodicalMonth}
                  onChange={handleInputChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div>
                ...
                <select
                  name="departmentToIssue"
                  value={formData.departmentToIssue}
                  onChange={handleInputChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
              ...
              <div>
                ...
                <input
                  type="date"
                  name="departmentIssueDate"
                  value={formData.departmentIssueDate}
                  onChange={handleInputChange}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  type="text"
                  name="poNo"
                  list="po-no-suggestions" // Link to datalist
                  value={formData.poNo}
                  onChange={(e) => {
                    handleInputChange(e);
                    fetchFieldSuggestions("poNo", e.target.value);
                  }}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
            ...
            <div className="mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    list="vendor-name-suggestions" // Link to datalist
                    ...
                    onChange={(e) => {
                      ...
                      fetchFieldSuggestions("vendorName", e.target.value);
                    }}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>{
                      ...
                      fetchFieldSuggestions('vendorPhone', e.target.value)
                    }}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>{
                      ...
                      fetchFieldSuggestions('vendorEmail', e.target.value)
                    }}
                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <div className="mt-4">
              ...
              <textarea
                name="remarksForPayment"
                value={formData.remarksForPayment}
                onChange={handleInputChange}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                rows="2"
              />
      ...
      {/* Add these at the very bottom of your return block */}
      <datalist id="vendor-name-suggestions">
        {suggestions?.vendorNames?.map((name, i) => (
          <option key={i} value={name} />
        ))}
      </datalist>
      <datalist id="vendor-phone-suggestions">
        {suggestions?.phones?.map((phone, i) => (
          <option key={i} value={phone} />
        ))}
      </datalist>
      <datalist id="vendor-email-suggestions">
        {suggestions?.emails?.map((email, i) => (
          <option key={i} value={email} />
        ))}
      </datalist>
      <datalist id="po-no-suggestions">
        {suggestions?.poNumbers?.map((no, i) => (
