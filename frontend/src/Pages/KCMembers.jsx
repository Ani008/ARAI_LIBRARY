...
const KCMembers = () => {
  ...
  const fetchMembers = async (page = 1) => {
    try {
      const res = await api.get("/kcmembers", {
        params: {
          page: currentPage,
          limit,
          search,
  ...
  const fetchCounts = async () => {
    const res = await api.get("/kcmembers/counts");
    setMembershipCounts(res.data.data);
  };

  return (
    <PermissionGuard
      module="kcmembers"
      fallback={<AccessDeniedOverlay title="KC Members Management" />}
    >
            ...
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
              <div className="p-5 flex flex-wrap gap-4 items-center">
                ...
                >
                  ...
                  <option value="Automotive Abstract">
                    Automotive Abstract
                  </option>
