...
const PeriodicalManagement = () => {
  ...
  const handleEdit = (periodical) => {
    setFormData({
      ...periodical,
      subscriptionDate: formatDate(periodical.subscriptionDate),
      receiptDate: formatDate(periodical.receiptDate),
      departmentIssueDate: formatDate(periodical.departmentIssueDate),
